defmodule OpenRtbEctoTest do
  ...
  describe "cast/2" do
    ...
    test "invalid json" do
      assert {:error, %Poison.ParseError{}} = OpenRtbEcto.cast(BidRequest, "blarg{")
    end
  ...
  describe "json encoding" do
    test "all structs have Poison.Encoder implementations" do
      ...
      assert Enum.all?(mods, &Poison.encode!/1)
    end
  end
end
